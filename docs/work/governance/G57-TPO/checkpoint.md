...
contradictory operator instructions, generated-state drift, and an incomplete allowlist; coverage is the 29-method
...
`tests/governance/test_work_state.py` contains 29 grouped methods covering schema validation, dependency cycles, frozen
...
Add or materially rewrite about 20 to 29 grouped governance claims. The budget exceeds the normal 15-claim guideline
...
markers; and malformed handoff heads fail before subprocess observation. The existing 29 grouped methods exercise
